...
# functions and packages
	...
	dir_data<-"data\\fleet_reg\\output\\2019\\"
	...
	for (ctry in c("BEL","DEU","DNK","ESP","EST","FIN","FRA","GBR","IRL","LTU","LVA","NLD","POL","PRT","SWE"))
{
	...
	# a few formats and quality checks
		...
		sum(is.na(fleetreg$Ton_Gt)) #if sum!=0 then add Ton_Ref (in 2019 we haven't got variable Ton_ref, only ton_other)
...
color_kasia<-c("#003153","steelblue","#110141","#800080","#4B0082","slategray","#6066ad","seashell3","#017351","#03c383","#aad962","#ef6a32","#607d8b","#ed0345","#a12a5e","#710162","slateblue4","orangered4","#0096c8","#ddeeff","peru","#013033","#FFC125","violetred4","wheat1","orange","#ce93d8","#6b8e23","#002D6E","slategray2","gold","#6b416b","#DED5D0","#36454F","#964B84","#555555","skyblue4")
colour_table$colour4<-color_kasia
